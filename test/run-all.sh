...
SUITES="agent-lint substrate gates floor axioms sensors security perf refactor holdout upkeep product waves health tier launcher status findings candidates report endtoend"
FAILED=''
START="$(date -u +%s)"
