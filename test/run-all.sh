...
SUITES="agent-lint substrate gates floor axioms sensors refactor holdout upkeep product waves health tier launcher status findings candidates report endtoend"
FAILED=''
START="$(date -u +%s)"
