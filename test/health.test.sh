...
enter_feature F003-health >/dev/null 2>&1 || true
...
enter_feature F004-fail >/dev/null 2>&1 || true
i=0
...
enter_feature F005-osc >/dev/null 2>&1 || true
...
enter_feature F006-churn >/dev/null 2>&1 || true
i=0
while [ "$i" -lt 3 ]; do
...
enter_feature F007-ladder >/dev/null 2>&1 || true
...
enter_feature F008-next >/dev/null 2>&1 || true
